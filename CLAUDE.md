...
| 003 | 남긴 것들 (Evidence Log) | 하루 한 줄 증거 기록 → 결핍 1·2위(증거/방향) 직접 타격 + 2~3주 사용으로 **검증** | 구현됨 |
| 004 | 알찬 지도 | 시간 사용 × 욕구 매핑 — "매 순간 알찬 삶" **측정** | 백로그 |
| 005 | 나 사용 설명서 | #001~#004 데이터 **종합** 자동 생성 페이지 | 백로그 |
